...
#region File Exceptions
        public const string FILE_CONTENT_ARRAY_LENGTH_IS_ZERO = "No one file in [{0}] was read";
        public const string FAILED_TO_READ_FILE = "Failed to read file {0}. {1}";
        public const string EMPTY_FILE_EXCEPTION = "File {0} is empty";
        public const string WRONG_FILE_PATH_EXCEPTION = "Wrong file path [{0}]. ";
        public const string DIRECTORY_DOESNOT_EXIST = "Directory [{0}] doesn't exist";
        ...
        public const string FILE_DOESNOT_CONTAIN_ANY_NAMESPACE = "{0} doesn't contain any namespace.";
        public const string FILE_DOESNOT_CONTAIN_ANY_CLASS = "{0} doesn't contain any class";
